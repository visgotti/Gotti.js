        ...
        names.forEach(name => {
            ...
            this.auth[name] = (requestPayload) => __awaiter(this, void 0, void 0, function* () {
                return new Promise((resolve, reject) => {
                    httpPostAsync(`${this.webProtocol}//${this.hostname}${Protocol_1.GOTTI_HTTP_ROUTES.BASE_AUTH}/${name}`, '', {
    ...
    addGateRoutes(names) {
        names.forEach(name => {
            ...
            this.gate[name] = (requestPayload) => __awaiter(this, void 0, void 0, function* () {
                return new Promise((resolve, reject) => {
                    httpPostAsync(`${this.webProtocol}//${this.hostname}${Protocol_1.GOTTI_HTTP_ROUTES.BASE_GATE}/${name}`, '', {
                        [Protocol_1.GOTTI_ROUTE_BODY_PAYLOAD]: requestPayload,
                        [Protocol_1.GOTTI_GATE_AUTH_ID]: this.authId,
                    }, (err, data) => {
                        if (err) {
    ...
    addApiRoutes(names) {
        names.forEach(name => {
            this.api[name] = (requestPayload) => __awaiter(this, void 0, void 0, function* () {
                return new Promise((resolve, reject) => {
                    httpPostAsync(`${this.webProtocol}//${this.hostname}${Protocol_1.GOTTI_HTTP_ROUTES.BASE_PUBLIC_API}/${name}`, '', {
                        [Protocol_1.GOTTI_ROUTE_BODY_PAYLOAD]: requestPayload,
                    }, (err, data) => {
                        if (err) {
                            return reject(err);
