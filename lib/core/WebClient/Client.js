...
class Client extends EventEmitter {
    ...
    authenticate(options, tokenHeader) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                httpPostAsync(`${this.hostname}${Protocol_1.GOTTI_HTTP_ROUTES.BASE_AUTH}${Protocol_1.GOTTI_HTTP_ROUTES.AUTHENTICATE}`, this.webProtocol, tokenHeader, { [Protocol_1.GOTTI_AUTH_KEY]: options }, (err, data) => {
                    if (err) {
    ...
    register(options, tokenHeader) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                httpPostAsync(`${this.hostname}${Protocol_1.GOTTI_HTTP_ROUTES.BASE_AUTH}${Protocol_1.GOTTI_HTTP_ROUTES.REGISTER}`, this.webProtocol, tokenHeader, { [Protocol_1.GOTTI_AUTH_KEY]: options }, (err, data) => {
                    if (err) {
                        return reject(`Error requesting game ${err}`);
                    }
                    else {
    ...
    getGames(clientOptions, token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                httpPostAsync(`${this.hostname}${Protocol_1.GOTTI_HTTP_ROUTES.BASE_GATE}${Protocol_1.GOTTI_HTTP_ROUTES.GET_GAMES}`, this.webProtocol, token, {
    ...
    joinGame(gameType, joinOptions, token, fps = 60) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (found.isNetworked) {
                ...
                return new Promise((resolve, reject) => {
                    httpPostAsync(`${this.hostname}${Protocol_1.GOTTI_HTTP_ROUTES.BASE_GATE}${Protocol_1.GOTTI_HTTP_ROUTES.JOIN_GAME}`, this.webProtocol, token, {
                        gameType,
