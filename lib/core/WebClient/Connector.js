...
exports.Connector = exports.AreaStatus = void 0;
...
class Connector {
    ...
    sendSystemMessage(message) {
        this.connection.send([28 /* SYSTEM_MESSAGE */, message.type, message.data, message.to]);
    }
    sendImmediateSystemMessage(message) {
        this.connection.send([29 /* IMMEDIATE_SYSTEM_MESSAGE */, message.type, message.data, message.to]);
    }
    get hasJoined() {
