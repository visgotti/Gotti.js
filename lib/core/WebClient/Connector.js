...
class Connector {
    ...
    connect(gottiId, connectorURL, process, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.connection = new Connection_1.Connection(url, options.isWebRTCSupported);
    ...
    startPeerConnection(peerIndex, signalData) {
        let peerConnection = this.peerConnections[peerIndex];
        if (!(peerConnection)) {
            this.peerConnections[peerIndex] = new PeerConnection_1.PeerConnection(this.connection, peerIndex);
