...
class ProcessManager {
    ...
    changeAreaProcess(areaType, areaData) {
    ...
    changeGameProcessSetup(gameType, gameOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.runningGameProcess) {
                this.clearAllProcesses();
            }
            return yield this.initializeGame(gameType, gameOptions);
        });
    }
    clearAllProcesses() {
    ...
    initializeGame(gameType, gameOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (process.globals) {
                if (typeof process.globals === "function") {
                    globals = yield process.globals(gameOptions, this.client);
                }
                else {
            ...
            process.systems.forEach(s => {
                this.runningGameProcess.addSystem(s, gameOptions);
            });
